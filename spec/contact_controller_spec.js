...
describe('ContactController', () => {
	...
	describe("search methods", () => {
		...
		describe("#binarySearch()", () => {
			...
			it("should return null when called with an empty array", () => {
				expect(this.binarySearch([], "Alloy Rodriguez")).toBeNull();
			});
			...
			it("should return the contact if found", (done) => {
				this.book
				.addContact(...alloy).then(() => {
					this.book
					.addContact(...magus).then(() => {
						this.book
						.addContact(...zelda).then(() => {
							this.book
							.addContact(...snake).then(() => {
								this.book
	...
	describe("#delete()", () => {
		...
		it("should remove the contact that matches the ID passed", (done) => {
			...
			this.book
			.addContact("Rick Deckard", "000-000-000", "null@null.com").then((contact) => {
				this.book
				.getContacts()
				.then((contacts) => {
					expect(contacts[0].name).toBe("Rick Deckard");
